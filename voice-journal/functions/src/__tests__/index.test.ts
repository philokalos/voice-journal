...
import { calculateChanges, extractInsights } from '../index'
...
describe('Cloud Functions', () => {
  ...
  describe('calculateChanges', () => {
    ...
    it('should return empty object when no changes', () => {
      ...
      const changes = calculateChanges(data, { ...data, updated_at: '2024-01-02' })
  ...
  describe('extractInsights', () => {
    ...
    it('should limit results to maximum counts', () => {
      ...
      const insights = extractInsights(longTranscript)
  ...
  describe('Integration Tests', () => {
    ...
    it('should handle sentiment analysis workflow', async () => {
      ...
      const insights = extractInsights(mockData.transcript)
