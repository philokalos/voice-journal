...
import { NotionService } from '../../domains/integrations/services/notionService'
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        const result = await NotionService.exchangeCode(code, state)
        ...
        setStatus('error')
        setMessage(error instanceof Error ? error.message : 'Notion 연동에 실패했습니다.')
